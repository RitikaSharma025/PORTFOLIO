        ...
        <Column classes="mt-12 w-full">
          <WrappedBox classes="sm:grid-cols-2 w-full mx-auto gap-4">
            <Row
              ...
              onClick={() =>
                onHandleClickUrl("mailto:ritikasharma11154@gmail.com")
              }
            >
          ...
          <h3 className="text-center mx-auto mt-12">
            I&apos;m{" "}
            <span className="text-[var(--primaryColor)]">Looking</span> for
            Software Development Intern Or Full-Time Roles.
          </h3>
        </Column>
      </ConstraintedBox>
    </ResponsiveBox>
